...
def train(mnist):
    ...
    # 直接使用p126_mnist_inference.py中定义的前向传播过程
    y = p126_mnist_inference.inference(x,regularizer)
    ...
    with tf.Session() as sess:
        ...
        for i in range(TRAINING_STEPS):
            ...
            if i % 1000 == 0:
                ...
                # 保存模型的文件名末尾加上训练的轮数，比如"p127_model.ckpt-1000"表示
                # 训练1000轮之后得到的模型
                saver.save(
